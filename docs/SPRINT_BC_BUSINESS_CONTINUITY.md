...
| **BC-10** | Fix `health-watchdog`'s consecutive-failure watchlist: add `generation-resume`, `payment-reconciliation`, `data-retention`; remove the nonexistent `'email-scheduler'` entry | G-7 | code | 0.5 day | TODO |
