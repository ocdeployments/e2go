...
function scoreDenialFactors(
  ...
  // D-05 — Business plan generic, vague, or inconsistent
  {
    ...
    if (hasPlan && hasBasis) {
      ...
      mitigation = 'Build your business plan in Tab K of Module 3 — E2go.app assembles your complete business plan document from your answers there. A professional business plan is required at the E-2 interview.';
    }
