...
export const DOC_DISPLAY_NAMES: Record<string, string> = {
  ...
  financial_assets_portfolio: 'Financial_Assets_Portfolio',
  org_chart: 'Org_Chart',
  corporate_documents_guide: 'Corporate_Documents_Guide',
  lease_premises_summary: 'Lease_Premises_Summary',
...
export const DOC_TYPE_TAB_MAP: Record<string, string> = {
  ...
  financial_assets_portfolio: 'E',
  org_chart: 'I',
  corporate_documents_guide: 'J',
  lease_premises_summary: 'J',
