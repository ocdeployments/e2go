// Static label maps live in data/question-labels.ts — imported here for internal use
// and re-exported so existing importers of this module don't need to change.
export { QUESTION_LABELS, SECTION_MAP, SECTION_LABELS } from '@/data/question-labels';
import { QUESTION_LABELS, SECTION_LABELS, SECTION_MAP } from '@/data/question-labels';
