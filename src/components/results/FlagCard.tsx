...
export const FLAG_REMEDIATION: Record<string, FlagRemediation> = {
  'W-REFUSAL-RECENT': {
    ...
    placeholder: 'e.g. I was refused a B-1/B-2 visitor visa in 2022 because I did not demonstrate strong ties to my home country. Since then, I have purchased a home and my spouse and children remain there.',
  ...
  'W-REFUSAL-OLD': {
    ...
    answerKey: 'QR-REFUSAL-DETAIL',
    placeholder: 'e.g. I was refused a tourist visa in 2015 because I had recently changed jobs. I now have stable employment with 12 years of tenure and own property in my home country.',
  ...
  'W-REFUSAL-MULTIPLE': {
    ...
    answerKey: 'QR-REFUSAL-DETAIL',
    placeholder: 'e.g. First refusal: 2018, B-1/B-2, reason [X]. Second refusal: 2021, F-1, reason [Y]. Since then I have: purchased property, secured long-term employment, my family remains in my home country.',
  ...
  'W-FAMILY-GIFT': {
    ...
    placeholder: 'e.g. My father gifted me $180,000 (USD) in March 2025. He is a retired engineer with documented savings. I have a signed gift letter, his bank statement showing the transfer, and a notarized statutory declaration.',
  ...
  'W-LOAN-FUNDED': {
    ...
    placeholder: 'e.g. The loan is a home equity line of credit secured by my primary residence, appraised at $850,000 with $400,000 in equity. The business is not used as collateral.',
  ...
  'W-WEAK-TIES': {
    ...
    placeholder: 'e.g. Property: 3-bed home at [address], owned outright, appraised at $650K. Family: spouse [name] and two children (ages 10, 14) remain in [home country]. Employment: retained advisory role at [company name]. Retirement and savings accounts at [bank] totalling $280K.',
  ...
  'W-ENTRY-REFUSED': {
    ...
    placeholder: 'e.g. I was refused entry at a U.S. port of entry in January 2019 on grounds of suspected intent to work without authorization. I was returning from a client meeting. Since then I have obtained a formal legal opinion confirming the visit was lawful.',
  ...
  'W-CONVICTION-RECENT': {
    ...
    placeholder: 'e.g. DUI conviction in [jurisdiction], September 2016. Fine of $1,500 and 6-month license suspension. Sentence fully served. No criminal record since. I have a Certificate of Completion and my license was reinstated in March 2017.',
  ...
  'W-CONVICTION-OLD': {
    ...
    answerKey: 'QR-CONVICTION-DETAIL',
    placeholder: 'e.g. Minor shoplifting charge, age 19, [jurisdiction] 2003. Community service order completed. Conditional discharge — no criminal record. Formally pardoned/expunged under [local statute] in 2006.',
  ...
  'W-PARTNERSHIP-SPLIT': {
    ...
    placeholder: 'e.g. Partner A (me): 60% owner — day-to-day operations, hiring, and vendor relationships. Partner B: 40% owner — marketing, sales strategy, and client development. Both partners hold treaty-country nationality. Both will file separate E-2 visa applications.',
