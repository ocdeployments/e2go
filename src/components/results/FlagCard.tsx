...
export const FLAG_REMEDIATION: Record<string, FlagRemediation> = {
  ...
  'W-CONVICTION-RECENT': {
    ...
    placeholder: 'e.g. DUI conviction in Ontario, Canada, September 2016. Fine of $1,500 and 6-month license suspension. Sentence fully served. No criminal record since. I have a Certificate of Completion and my license was reinstated in March 2017.',
