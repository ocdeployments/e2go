...
export default function TabShell({
      ...
      <div className="min-h-screen" style={{ background: "var(--navy)" }}>
        ...
        <main className="pt-24 pb-12 px-4 max-w-2xl mx-auto">
          <div className="glass p-8 text-center">
            ...
            <h1 className="text-2xl font-semibold mb-4 font-playfair" style={{ color: "var(--white)", fontSize: '24px', fontWeight: 600 }}>
              {tabTitle}
            </h1>

            {/* 2-line description */}
            <p className="mb-8" style={{ color: "var(--white-dim)", fontSize: '16px', lineHeight: '24px' }}>
              {tabDescription}
            </p>

            {/* Question count */}
            <p className="text-sm mb-8" style={{ color: "var(--white-dim)", fontSize: '14px' }}>
            ...
            <button
              ...
              style={{ minHeight: '56px', borderColor: "var(--glass-border)", color: "var(--white-dim)" }}
            >
              Back
            </button>
          </div>
      ...
      <div className="min-h-screen" style={{ background: "var(--navy)" }}>
        ...
        <main className="pt-24 pb-24 px-4 max-w-2xl mx-auto">
          <div className="glass p-8 text-center">
            ...
            <p className="mb-6" style={{ color: "var(--white-dim)", fontSize: '16px', lineHeight: '24px' }}>
              ...
              <div className="glass p-4 mb-6 text-left">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm" style={{ color: "var(--white-dim)" }}>{nextTab.description}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4" style={{ background: "rgba(6,13,31,0.9)", borderTop: "1px solid var(--glass-border)" }}>
      ...
      <div className="min-h-screen" style={{ background: "var(--navy)" }}>
        ...
        <main className="pt-24 pb-12 px-4 max-w-2xl mx-auto">
          <div className="glass p-8">
            <div className="h-8 rounded w-1/3 mb-4 animate-pulse" style={{ background: "var(--glass-border)" }} />
            <div className="h-4 rounded w-2/3 mb-8 animate-pulse" style={{ background: "var(--glass-border)" }} />
            <div className="space-y-4">
              <div className="h-12 rounded animate-pulse" style={{ background: "var(--glass-border)" }} />
              <div className="h-12 rounded animate-pulse" style={{ background: "var(--glass-border)" }} />
              <div className="h-12 rounded animate-pulse" style={{ background: "var(--glass-border)" }} />
            </div>
          </div>
  ...
  if (loadError) {
    return (
      <div className="min-h-screen p-4 flex items-center justify-center" style={{ background: "var(--navy)" }}>
        <div className="max-w-md text-center">
          <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style={{ background: "rgba(239,68,68,0.2)" }}>
            <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" style={{ color: "#fca5a5" }}>
              <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z" />
            </svg>
          </div>
          <h2 className="text-xl font-bold mb-2 font-playfair" style={{ color: "var(--white)" }}>Failed to load answers</h2>
          <p className="mb-6" style={{ color: "var(--white-dim)" }}>{loadError}</p>
          {onRetry && (
            <button
              onClick={onRetry}
      ...
      <main className="pt-24 pb-24 px-4 max-w-2xl mx-auto">
        ...
        {currentQuestion && (
          <div className="glass p-6">
            ...
            <div className="flex justify-between mt-8 pt-6 border-t" style={{ borderColor: "var(--glass-border)" }}>
              <button
                onClick={handleBack}
                className="px-6 py-3 border rounded-lg transition-colors"
                style={{ minHeight: '56px', borderColor: "var(--glass-border)", color: "var(--white-dim)" }}
