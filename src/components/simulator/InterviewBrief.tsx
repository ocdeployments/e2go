  ...
  return (
    <div style={s.root}>
      ...
      <p style={s.disclaimer}>
        This report is generated by the E2go.app intelligence engine using your application data and 15 documented denial-risk factors. It is not legal advice. Review with your attorney before your interview.
      </p>
    </div>
  );
}
