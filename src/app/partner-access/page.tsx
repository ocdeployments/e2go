  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Wordmark */}
        <Link href="/" style={{ display: "inline-block", textDecoration: "none", margin: "0 0 4px", fontSize: "18px", fontWeight: 300, color: "#C9A84C", letterSpacing: "0.04em", fontFamily: "'Cormorant Garamond', serif" }}>
