  ...
  return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", fontFamily: "'DM Sans', system-ui, sans-serif", color: "#f5f0e8" }}>
      ...
      <div style={{ padding: "48px 40px 40px", maxWidth: "680px" }}>
        ...
        <div style={{ fontSize: "14px", color: "rgba(245,240,232,0.74)", marginBottom: "40px", lineHeight: 1.6 }}>Change any answer below — your results will update automatically.</div>
        ...
        {answeredIds.length === 0 ? (
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            {SECTION_ORDER.filter(s => grouped[s]).map(section => (
              <div key={section}>
                <div style={{ fontSize: "10px", letterSpacing: "0.14em", textTransform: "uppercase", color: "rgba(201,168,76,0.82)", marginBottom: "12px", paddingBottom: "8px", borderBottom: "1px solid rgba(201,168,76,0.08)" }}>{section}</div>
                <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                  {grouped[section].map(item => (
                    ...
                    >
                      ...
                      <div style={{ fontSize: "11px", color: "rgba(245,240,232,0.70)", letterSpacing: "0.04em", flexShrink: 0, marginLeft: "16px" }}>Change →</div>
                    </div>
                  ))}
                </div>
              </div>
