    ...
    <div className="min-h-screen flex flex-col" style={{ background: "#0a0a0a" }}>
      ...
      <main className="flex-1 px-4 py-12 max-w-3xl mx-auto w-full">
        ...
        <p style={{ ...bodyText, fontSize: "13px", color: "rgba(245,240,232,0.76)", marginBottom: "32px" }}>
          Company: Prodigal Son IT Solutions LLC, a Texas limited liability company, doing business as E2go.app
          <br />
        ...
        <div style={bodyText}>
          <p style={{ marginBottom: "16px" }}>
            By creating an account or using E2go.app at E2go.app, you agree to these Terms. If you do not agree, do not use the platform.
          </p>

          {/* Section 1 */}
          <h2 style={sectionHeading}>1. What E2go.app Is</h2>
          <p style={{ marginBottom: "16px" }}>
            E2go.app is a self-guided software platform that helps E-2 Treaty Investor visa applicants organize their information, build their application package, and prepare for their consulate interview.
          </p>
          <p style={{ marginBottom: "16px" }}>
          ...
          {/* Section 2 */}
          <h2 style={sectionHeading}>2. What E2go.app Does Not Do</h2>
          <p style={{ marginBottom: "12px" }}>E2go.app does NOT:</p>
          ...
          <p style={{ marginBottom: "16px" }}>
            Documents generated by E2go.app are produced by artificial intelligence based on the information you provide. You acknowledge that:
          </p>
          <p style={{ marginBottom: "16px" }}>
          ...
          <p style={{ marginBottom: "16px" }}>
            <strong style={{ color: "#f5f0e8" }}>Accuracy is your responsibility.</strong> E2go.app&apos;s responsibility ends at the point of download. What you submit is yours.
          </p>
          <p style={{ marginBottom: "16px" }}>
            <strong style={{ color: "#f5f0e8" }}>Regulations change.</strong> Immigration law and consular practice change frequently. E2go.app makes reasonable efforts to stay current but does not guarantee that documents reflect requirements at the exact time of your submission.
          </p>
          ...
          <p style={{ marginBottom: "16px" }}>
            <strong style={{ color: "#f5f0e8" }}>Payment processing</strong> is handled by Stripe, Inc. E2go.app does not store your card details.
          </p>
          ...
          <ul style={{ marginLeft: "20px", marginBottom: "16px", listStyleType: "disc" }}>
            ...
            <li style={{ marginBottom: "8px" }}>Visa denial is not grounds for a refund. Consular decisions are entirely outside E2go.app&apos;s control.</li>
          ...
          <p style={{ marginBottom: "16px" }}>
            E2go.app is operated from Texas, United States. We acknowledge the following additional obligations:
          </p>
          <p style={{ marginBottom: "16px" }}>
          ...
          <p style={{ marginBottom: "16px" }}>
            The E2go.app platform, software, methodology, design, and original content are owned by Prodigal Son IT Solutions LLC and protected by U.S. and international intellectual property law.
          </p>
          ...
          <ul style={{ marginLeft: "20px", marginBottom: "16px", listStyleType: "disc" }}>
            <li style={{ marginBottom: "8px" }}>Reproduce, distribute, or sell any E2go.app proprietary content</li>
            ...
            <li style={{ marginBottom: "8px" }}>Use E2go.app to build a competing service</li>
          </ul>
          ...
          <div style={warningBlock}>
            <p style={{ marginBottom: "12px" }}>
              TO THE MAXIMUM EXTENT PERMITTED BY LAW, E2GO.APP SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING VISA DENIAL, LOSS OF BUSINESS OPPORTUNITY, IMMIGRATION STATUS CONSEQUENCES, OR THE COST OF RETAINING LEGAL COUNSEL TO CORRECT APPLICATION MATERIALS.
            </p>
            <p style={{ marginBottom: "12px" }}>
              OUR TOTAL LIABILITY FOR ANY CLAIM ARISING FROM THESE TERMS OR YOUR USE OF THE PLATFORM SHALL NOT EXCEED THE AMOUNT YOU PAID E2GO.APP IN THE 12 MONTHS BEFORE THE CLAIM AROSE.
            </p>
            <p>
          ...
          <p style={{ marginBottom: "16px" }}>
            You agree to defend and hold harmless E2go.app, its officers, employees, and agents from claims arising from your use of the platform, information you provide that is false or inaccurate, or your violation of these Terms.
          </p>
          ...
          <p style={{ marginBottom: "16px" }}>
            Prodigal Son IT Solutions LLC (d/b/a E2go.app)
            <br />
            Texas, United States
          </p>
        </div>
