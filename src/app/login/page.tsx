    ...
    return (
      <div className="min-h-screen bg-[#f8f9ff] flex items-center justify-center">
        <div className="text-center">
          <div className="w-8 h-8 border-4 border-[#004ac6] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-[#434655]">Signing you in...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-xl border border-[#e2e8f0] p-8">
            ...
            <form onSubmit={handleEmailPasswordLogin} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full bg-[#004ac6] text-white font-medium py-3 rounded-lg hover:bg-[#00337d] transition-colors"
              >
                Sign In
              </button>
              ...
              <button
                ...
                className="w-full border border-[#004ac6] text-[#004ac6] font-medium py-3 rounded-lg hover:bg-[#e5eeff] transition-colors"
              >
                Send Magic Link
              </button>
            </form>
