...
const sections: Section[] = [
  {
    ...
    fields: [
      ...
      { key: "QH-02", type: "multiselect", label: "Where did the investment funds primarily come from?", options: [{value: "Personal savings (bank account)", label: "Personal savings (bank account)"}, {value: "Retirement account (RRSP, 401k, IRA, etc.)", label: "Retirement account (RRSP, 401k, IRA, etc.)"}, {value: "Sale of property", label: "Sale of property"}, {value: "Sale of a business", label: "Sale of a business"}, {value: "Inheritance or gift", label: "Inheritance or gift"}, {value: "Business profits", label: "Business profits"}, {value: "Loan (personal or business)", label: "Loan (personal or business)"}, {value: "Investment portfolio", label: "Investment portfolio"}, {value: "Other", label: "Other"}], required: true, privacy_category: "required" },
  ...
  },
  {
    ...
    title: "Transfer Path",
    fields: [
      { key: "QH-08", type: "multiselect", label: "How were the funds transferred to the U.S. business?", options: [{value: "Wire transfer to U.S. business account", label: "Wire transfer to U.S. business account"}, {value: "Direct franchise fee payment", label: "Direct franchise fee payment"}, {value: "Payment to U.S. attorney trust account", label: "Payment to U.S. attorney trust account"}, {value: "Purchase of U.S. business assets", label: "Purchase of U.S. business assets"}, {value: "Multiple transfers over time", label: "Multiple transfers over time"}, {value: "Other", label: "Other"}], required: true, privacy_category: "required" },
