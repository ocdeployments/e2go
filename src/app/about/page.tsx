...
export const metadata: Metadata = {
  title: "About E2go.app",
  description: "About E2go.app — Built for the journey, not just the documents. Learn how our E-2 visa preparation platform works.",
  openGraph: {
    title: "About E2go.app",
    description: "About E2go.app — Built for the journey, not just the documents.",
    type: "website",
    ...
    <main className="pt-20 pb-16 px-4 min-h-screen" style={{ background: "#0a0a0a" }}>
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-12" style={{ fontFamily: "'DM Sans', sans-serif", color: "rgba(245,240,232,0.75)", fontWeight: 300, lineHeight: 1.7, fontSize: "15px" }}>
          <section>
            <h2 className="text-2xl mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400, color: "#C9A84C" }}>Why E2go.app exists</h2>
            <p className="mb-4">
            ...
            <p className="font-medium" style={{ color: "#f5f0e8" }}>
              E2go.app is that discipline, automated.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              E2go.app prepares a complete, consulate-formatted E-2 application package.
            </p>
            <p className="mb-4">
