    ...
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#f5f0e8' }}>
      <div style={{ maxWidth: '820px', margin: '0 auto', padding: '64px 24px 80px' }}>
        ...
        <div style={{ marginBottom: '56px' }}>
          ...
          <p style={{ fontSize: '14px', color: 'rgba(245,240,232,0.78)', lineHeight: 1.8, maxWidth: '520px', fontFamily: "'DM Sans', sans-serif" }}>
        ...
        {/* How it works */}
        <div style={{ marginBottom: '56px' }}>
          <h2 style={{ fontSize: '13px', letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.68)', fontFamily: "'DM Sans', sans-serif", marginBottom: '24px', fontWeight: 400 }}>
            How it works
          </h2>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '2px' }}>
            {[
              ...
              <div key={step} style={{ padding: '20px', background: 'rgba(245,240,232,0.02)', border: '1px solid rgba(245,240,232,0.06)' }}>
                <div style={{ fontSize: '10px', letterSpacing: '0.1em', color: 'rgba(201,168,76,0.82)', fontFamily: "'DM Sans', sans-serif", marginBottom: '8px' }}>{step}</div>
                <div style={{ fontSize: '13px', color: '#f5f0e8', fontWeight: 500, fontFamily: "'DM Sans', sans-serif", marginBottom: '6px' }}>{label}</div>
                <div style={{ fontSize: '11px', color: 'rgba(245,240,232,0.72)', lineHeight: 1.6, fontFamily: "'DM Sans', sans-serif" }}>{desc}</div>
              </div>
            ))}
          </div>
        </div>
            ...
            {categoryList.map(([key, cat]) => (
              ...
              >
                <div>
                  ...
                  <span style={{ display: 'block', fontSize: '11px', color: 'rgba(245,240,232,0.72)', marginTop: '3px', fontFamily: "'DM Sans', sans-serif" }}>{cat.tagline}</span>
                </div>
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexShrink: 0 }}>
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                    <span style={{ fontSize: '10px', color: 'rgba(245,240,232,0.65)', fontFamily: "'DM Sans', sans-serif", marginBottom: '3px' }}>E-2 strength</span>
        ...
        >
          <h3 style={{ fontSize: '12px', letterSpacing: '0.08em', textTransform: 'uppercase', color: 'rgba(245,240,232,0.68)', fontFamily: "'DM Sans', sans-serif", marginBottom: '12px', fontWeight: 400 }}>
          ...
          <p style={{ fontSize: '12px', color: 'rgba(245,240,232,0.78)', lineHeight: 1.8, fontFamily: "'DM Sans', sans-serif", margin: 0 }}>
            ...
            E2go.app does not charge you for the introduction and does not receive a commission.
