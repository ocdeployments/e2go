              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                >
                  <p style={{ fontWeight: 500, color: 'rgba(245,240,232,0.8)', marginBottom: '12px', fontSize: '13px' }}>
                    E2go.app Terms of Service Summary
                  </p>
                  <p style={{ marginBottom: '10px' }}>
                    E2go.app is a document preparation platform. It is not a law firm
                    and does not provide legal advice. No attorney-client relationship
                    is created by using this platform.
                  </p>
                  <p style={{ marginBottom: '10px' }}>
                    Documents generated by E2go.app are produced using artificial
                    ...
                    E2go.app&apos;s responsibility ends at the point of download.
                  </p>
                  <p style={{ marginBottom: '10px' }}>
                    E2go.app does not guarantee visa approval. All consular decisions
                ...
                <div style={{
                  ...
                  >
                    ...
                    . I understand that E2go.app is not a law firm, does not provide
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginTop: '12px' }}>
                  ...
                  <label htmlFor="casl-consent"
                    ...
                    visa preparation from E2go.app. (Optional — unsubscribe any time.)
                  </label>
                </div>
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', marginTop: '12px' }}>
                  ...
                  <label htmlFor="outcomes-consent"
                    style={{ fontSize: '12px', color: 'rgba(245,240,232,0.76)', lineHeight: '1.5' }}>
                    I agree to share my anonymized visa outcome with E2go.app to help improve
